...
单件起订和急单均可。告知尺寸（ID×OD×CS）和材料等级，我们将即时确认库存。联系邮箱：jino.kim@ohitech.co.kr`,
  ...
  },
  {
    ...
    body: {
      ko: `**NVIDIA H100/H200 GPU 700W 방열에는 열전도율 10 W/m·K 이상 TIM이 필수입니다.** 일반 열전도 패드(3~5 W/m·K)는 열저항이 높아 GPU 온도가 설계 한계를 넘고 소자 수명이 단축됩니다. OHI Tech는 T-Global 한국 공식 파트너로서 AI 서버·EV 배터리·반도체 패키지에 맞는 열관리 소재를 공급하며 어떤 소재가 실제 효과를 내는지 직접 확인했습니다.
