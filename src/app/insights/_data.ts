...
AI 서버나 EV 배터리 방열 문제로 고민 중이시라면 현재 사용 중인 TIM 소재와 발열 조건을 알려주세요. OHI Tech 엔지니어링팀이 최적 소재를 추천해드립니다. jino.kim@ohitech.co.kr`,
...
Yes. Share your application conditions (power density, contact area, assembly method) and OHI Tech will provide samples and thermal resistance measurement data. Contact: jino.kim@ohitech.co.kr`,
...
**Q3. 选材前可以获取样品测试吗？**
可以。告知应用条件（功率密度、接触面积、组装方式），OHI Tech将提供样品及热阻测量数据。联系邮箱：jino.kim@ohitech.co.kr`,
    },
  },
  {
    slug: "ev-charging",
