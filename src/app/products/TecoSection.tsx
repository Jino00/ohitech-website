...
const LANG = {
  ...
  ja: {
    hero: {
      eyebrow: "TECO Electric & Machinery 韓国公式パートナー・OHI Tech総代理店",
      headline: "Move to Lead",
      sub: "70年の伝統・グローバルNo.2 LV配電・ドローンパワートレイントータルソリューション",
      cta1: "製品相談のお問い合わせ",
      cta2: "導入事例を見る",
      stats: [
        { value: "1956", label: "創立（TWSE 1504）" },
        { value: "40+", label: "進出国" },
        { value: "25,000+", label: "グローバル従業員" },
        { value: "USD 2.2B+", label: "2026年売上高" },
      ],
    },
    productNav: "製品カテゴリー",
    products: [
      {
        ...
        name: "ACコンタクタ",
        nameEn: "AC Contactor (CN/CU/TMC Series)",
        tagline: "6A〜800A・CSA・UL・CE・CCC認証",
        desc: "大負荷の電源を自動でON/OFFする配電の中核部品です。CN/CU/TMCシリーズ6〜800Aの全ラインナップを展開し、AC1〜AC4のあらゆる負荷区分に対応します。CSA・UL・CE・CCC・RoHSの国際認証により、グローバルプロジェクトへ即座に適用できます。",
        lineup: [
          { model: "CN/CUシリーズ", spec: "IEC規格・6A〜630A・3極/4極" },
          { model: "TMC-Eシリーズ", spec: "9A〜38A・軽工業専用・スリムデザイン" },
          { model: "TMC-Zシリーズ", spec: "40A〜800A・大容量コンタクタ" },
          { model: "RAM/RANリレー", spec: "AC 1.2〜6A・DC 0.27A〜0.55A・補助リレー" },
        ],
        apps: ["産業オートメーション", "工場自動化", "ビル電気設備", "発電所"],
      },
      {
        id: "overload",
        name: "過負荷継電器",
        nameEn: "Overload Relay (RHU/EOR)",
        tagline: "0.1〜336A・モーター過熱保護",
        desc: "過電流によるモーター損傷を防止する保護装置です。コンタクタと組み合わせてモーター回路の安全を確保します。熱動形（バイメタル式）と電子式の2タイプで、あらゆる負荷環境に対応します。",
        lineup: [
          { model: "RHU/RHNシリーズ", spec: "熱動形・0.1〜336A・欠相保護内蔵" },
          { model: "EORシリーズ", spec: "電子式・0.1〜200A・精密トリップ" },
        ],
        apps: ["モーター保護", "ポンプシステム", "コンベア", "圧縮機"],
      },
      {
        id: "breaker",
        name: "回路遮断器",
        nameEn: "Circuit Breaker (TMS/BM/BR/TCB/ACB)",
        tagline: "最大6300A・モーター保護〜ACB全ラインナップ",
        desc: "短絡・過負荷などの危険発生時に回路を即座に遮断する安全装置です。小型MCBから大容量ACBまで全ラインナップを保有し、台湾配電市場No.2として実証された信頼性を誇ります。",
        lineup: [
          { model: "TMS-Sシリーズ", spec: "モーター保護用・0.1〜32A・IP20" },
          { model: "BM/BRシリーズ", spec: "MCBミニチュア形・1〜125A・CE/CCC" },
          { model: "TCB/TAXシリーズ", spec: "MCCBモールドケース・16〜800A" },
          { model: "TAW/BAW/TBWシリーズ", spec: "ACB・最大6300A・DCスイッチ4000A" },
          { model: "TDS/BOT/VBTシリーズ", spec: "ACB派生形・63〜4000A" },
        ],
        apps: ["産業用配電盤", "高層ビル", "発電所送電", "データセンター"],
      },
      {
        id: "drone",
        name: "軽量ドローンモーター",
        nameEn: "Light Drone Motor Series",
        tagline: "10機種・330W〜3802W・台湾製",
        desc: "商用ドローン向けに最適化された高性能BLDCモーターシリーズです。日本製の高品質ベアリングと200°C耐熱絶縁鋼板を採用。Halbach Arrayアウターロータ設計によりトルク密度を+25%向上させ、最高91.8%の効率を実現します。",
        lineup: [
          { model: "2317 KV800", spec: "330W・81.5g・10インチプロペラ" },
          { model: "3024 KV790", spec: "2300W・145g・8S" },
          { model: "3115 KV900", spec: "1600W・126g・6S" },
          { model: "3508 KV650", spec: "350W・78.5g・4S" },
          { model: "4535 KV620", spec: "3600W・522g・12S・18インチ" },
          { model: "6013 KV210", spec: "2700W・385g・22インチ" },
          { model: "6023 KV220", spec: "3400W・515g・22インチ" },
          { model: "10010 KV110", spec: "3802W・810g・36インチ・大型ドローン用" },
        ],
        apps: ["測量・マッピング", "セキュリティ監視", "配送", "産業検査"],
      },
      {
        id: "uav",
        name: "農業・中大型UAVパワートレイン",
        nameEn: "Medium UAV Powertrain System",
        tagline: "最大150kgペイロード・76.5kg/ローター推力",
        desc: "台湾で月産1,400台以上を誇る中大型UAV専用パワートレインです。特許技術5件（うち発明特許1件）を保有。スロット内空冷、20gの耐衝撃性、コンフォーマルコーティングにより過酷な環境に対応します。農薬散布・物流・救助任務で実証済みのソリューションです。",
        lineup: [
          { model: "Drone 1", spec: "76.5kg/ローター・12.9kWピーク・4.65kW定格・63×24インチプロペラ" },
          { model: "Drone 2", spec: "40kg/ローター・8.6kWピーク・4kW定格・54×20インチプロペラ" },
          { model: "ESC (Drone 1)", spec: "300Aピーク・CAN+PWM・0.67kg" },
          { model: "ESC (Drone 2)", spec: "150Aピーク・CAN+PWM・0.42kg" },
        ],
        apps: ["農薬散布", "大型貨物輸送", "災害救助", "産業点検"],
      },
      {
        id: "esc",
        name: "ESC電子スピードコントローラー",
        nameEn: "Electronic Speed Controller",
        tagline: "LC-ESCシリーズ・4-12S LiPo・PWM制御",
        desc: "TECOドローンモーターと完全にマッチする専用ESCです。95〜98%の駆動効率と体積密度30%向上を実現。軽量設計により飛行時間の延長に貢献します。",
        lineup: [
          { model: "LC-ESC-20A-6S", spec: "4-6S LiPo・20A定格・30Aピーク・11g" },
          { model: "LC-ESC-40A-6S", spec: "4-6S LiPo・40A定格・70Aピーク・13g" },
          { model: "LC-ESC-40A-12S", spec: "8-12S LiPo・40A定格・80Aピーク・25g" },
        ],
        apps: ["軽量ドローン", "測量用UAV", "空撮ドローン", "FPVレーシング"],
      },
      {
        id: "ecm-ir",
        name: "ECモーター（インナーロータ形）",
        nameEn: "EC Motor — Internal Rotor (D98 / D125)",
        tagline: "60W〜750W・PMSM・FCU・AHU専用",
        desc: "永久磁石同期モーター（PMSM）を採用したインナーロータ形ECモーターです。D98シリーズ（60〜200W）は小型FCU・ダクト式ファンコイルに、D125シリーズ（350〜750W）は大型AHU・ダクト式空調ユニットに最適化されています。SVPWMとシャフト電流遮断設計により低振動・低騒音を実現。負荷や電源電圧の変動に左右されない閉ループ制御で安定した回転速度を維持します。",
        lineup: [
          { model: "D98（単軸）", spec: "60〜200W・1Ø 100〜240Vac・500〜1550 RPM・効率>80%・FCU/FFU" },
          { model: "D125（デュアル軸）", spec: "350〜750W・1Ø 220〜240Vac・500〜1350 RPM・効率>85%・ダクト式AHU" },
          { model: "D160（外部ドライブ）", spec: "600〜1400W・3Ø 220Vac・2026年Q4発売予定" },
          { model: "D180（一体形）", spec: "1800〜2200W・3Ø 380Vac・2027年Q1発売予定" },
        ],
        apps: ["ファンコイルユニット（FCU）", "ダクト式空調", "小型空調ユニット", "HVAC省エネ"],
      },
      {
        id: "ecm-er",
        name: "ECモーター（アウターロータ形）",
        nameEn: "EC Motor — External Rotor (OD102 / OD180)",
        tagline: "60W〜3700W・2×4〜4×4 FFU・ファンウォールシステム",
        desc: "アウターロータ構造で遠心ファン・軸流ファンを直結駆動するECモーターです。OD102（60〜350W）は2×4・4×4 FFUおよび排気ユニットに、OD180（3000〜3700W）は大型ファンウォールシステム・冷却塔に最適です。定格負荷時のTHD-A＜10%という低高調波、逆電流・過温・ストールに対する完全保護を備えます。",
        lineup: [
          { model: "OD102", spec: "60〜350W・1Ø 200〜277Vac・500〜1600 RPM・2×4/4×4 FFU" },
          { model: "OD138", spec: "300〜750W・1Ø 200〜277Vac・ファンウォールシステム・2026年Q4発売予定" },
          { model: "OD150", spec: "1500〜2200W・3Ø 380Vac・ファンウォールシステム・2027年Q2発売予定" },
          { model: "OD180", spec: "3000〜3700W・3Ø 380Vac・600〜1800 RPM・ファンウォール/冷却塔" },
        ],
        apps: ["ファンフィルターユニット（FFU）", "クリーンルームファンウォール", "排気ユニット", "冷却塔"],
      },
      {
        id: "ecm-drv",
        name: "ECドライバーボード",
        nameEn: "EC Driver Board",
        tagline: "1Ø 100〜240Vac・3速度/アナログ/通信制御",
        desc: "ECモーターメーカー向けの独立型ドライバーボードです。単相100〜240Vac汎用入力、電圧許容範囲±10%。モーター速度制御500〜1300 RPM、トルク範囲9.8 kg・cm。3速度／アナログ／通信制御の3モードに対応し、過電流・過温・ストールの完全保護を内蔵します。",
        lineup: [
          { model: "ドライバーボード", spec: "1Ø 100〜240Vac・50/60Hz・最大電流1.4A（100V時）" },
          { model: "速度制御", spec: "500〜1300 RPM ±10 RPM・トルク9.8 kg・cm（500〜1200 RPM）" },
          { model: "制御モード", spec: "3速度／アナログ／RS485通信" },
        ],
        apps: ["ECモーターメーカー", "FCUメーカー", "FFUメーカー", "小型空調機器"],
      },
      {
        id: "ecm-int",
        name: "ECM統合モジュール",
        nameEn: "ECM (Integrated Motor + Drive)",
        tagline: "1φ 100〜240Vac・PMSM・デュアル軸一体形",
        desc: "モーターとドライブを1つのユニットに統合したECMモジュールです。FCU/FFU/AHUメーカーのシステム設計の複雑さを最小限に抑えます。閉ループ制御により、負荷や電源変動に左右されない安定した速度運用を実現。Modbusによる電流・電圧・電力・運転状態の監視および遠隔制御通信を内蔵します。",
        lineup: [
          { model: "ECM（デュアル軸）", spec: "1φ 100〜240Vac・500〜1300 RPM ± 10 RPM" },
          { model: "トルク制御", spec: "9.8 kg・cm（500〜1200 RPM）" },
          { model: "通信", spec: "Modbus・アナログ・PWM速度制御" },
        ],
        apps: ["FCU/FFU/AHUシステム統合", "汎用小型空調", "省エネ改修", "OEMモジュール供給"],
      },
      {
        id: "fcu",
        name: "ファンコイルユニット（FCU）",
        nameEn: "Fan Coil Unit — FCU-#300 / FCU-#600",
        tagline: "300〜600 CFM・CE認証・Modbus通信",
        desc: "TECO ECM一体形ファンコイルユニットです。単相100〜240Vac入力、3速度／アナログ無段階／通信制御に対応。FCU-#300（単軸、300CFM、20〜60W）は小型空調ユニットに、FCU-#600（デュアル軸、600CFM、60〜130W）は中型ダクト式ファンコイルに最適です。CE認証取得済み、Modbusによる電力・運転監視を搭載しています。",
        lineup: [
          { model: "FCU-#300（単軸）", spec: "D98 EC-PMSM・20〜60W・300 CFM・IP54・CE" },
          { model: "FCU-#600（デュアル軸）", spec: "D98 EC-PMSM・60〜130W・600 CFM・IP54・CE" },
          { model: "共通仕様", spec: "1Ø 100〜240V・500〜1550 RPM・THD-A＜15%・PF＞95%" },
        ],
        apps: ["住宅建物", "商業施設", "ホテル・ホスピタリティ", "小規模オフィス"],
      },
      {
        id: "ffu",
        name: "ファンフィルターユニット（FFU）",
        nameEn: "Fan Filter Unit — FFU-4×2 / FFU-4×4",
        tagline: "350〜1580 CFM・クリーンルームIP55・RS485",
        desc: "クリーンルーム・バイオ医薬・医療環境向けに最適化されたECM FFUです。FFU-4×2（インナーロータ形Ø98、170W、350CFM）は2×4クリーンルームタイルに、FFU-4×4（アウターロータ形Ø102、350W、1580CFM）は4×4の広域クリーンゾーンに使用します。IP55等級、5速度/VR/RS485通信制御に対応し、過温・過電圧・ストール保護を内蔵します。",
        lineup: [
          { model: "FFU-4×2", spec: "インナーロータ形Ø98・170W max・350 CFM（950rpm/150Pa）・IP55" },
          { model: "FFU-4×4", spec: "アウターロータ形Ø102・350W max・1580 CFM（1350rpm/150Pa）・IP55" },
          { model: "共通仕様", spec: "1Ø 200〜277V・THD-A＜15%・Modbus/RS485" },
        ],
        apps: ["クリーンルーム", "バイオ医薬・医療", "半導体製造", "ローカルクリーンゾーン"],
      },
      {
        id: "ahu",
        name: "空気調和ユニット（AHU）",
        nameEn: "Air Handling Unit — AHU-#800 / AHU-#1600",
        tagline: "800〜1600 CFM・PWM/RS485・商業用",
        desc: "大容量の商業建築・公共インフラ・医療施設向けECM AHUです。AHU-#800（単軸、800CFM、30〜240W）は中型空調に、AHU-#1600（デュアル軸、1600CFM、50〜500W）は大型建築・病院に最適です。PWM電力制御＋RS485通信、効率＞80%、PF＞95%、THD-A＜15%を実現します。",
        lineup: [
          { model: "AHU-#800（単軸）", spec: "D98 EC-PMSM・30〜240W・800 CFM・IP54・1.1A" },
          { model: "AHU-#1600（デュアル軸）", spec: "D125 EC-PMSM・50〜500W・1600 CFM・IP54・2.5A" },
          { model: "共通仕様", spec: "1Ø 200〜240V・500〜1350 RPM・Modbus/RS485" },
        ],
        apps: ["商業ビル", "ホテル・公共施設", "病院・ヘルスケア", "データセンター空調"],
      },
      {
        id: "mv-inverter",
        name: "中電圧インバーター（MV510）",
        nameEn: "MV Inverter — MV510 Series",
        tagline: "210kVA〜12,950kVA・セルバイパス・無停止運転",
        desc: "TECO MV510中電圧インバーターは、210kVAから12,950kVAまでの幅広い容量に対応する産業用中電圧ドライブです。セルバイパス技術によりセル故障時にも無停止運転が可能で、ポンプ・ファン・圧縮機・鉱山用コンベアなどの重工業設備に最適化されています。省エネ率は最大40%、力率は0.95以上です。",
        lineup: [
          { model: "MV510-210kVA〜630kVA", spec: "中電圧・3レベルNPCトポロジー・IP21/IP42" },
          { model: "MV510-800kVA〜2,000kVA", spec: "セルバイパス内蔵・オプションハーモニックフィルタ" },
          { model: "MV510-2,500kVA〜12,950kVA", spec: "大容量・鉱山/発電所専用" },
        ],
        apps: ["大型ポンプ・ファン", "鉱山用コンベア", "圧縮機", "発電所補機"],
      },
      {
        id: "lv-inverter",
        name: "低電圧インバーター（A510s/E510s/E710/F510/L510s）",
        nameEn: "LV Inverter — A510s / E510s / E710 / F510 / L510s",
        tagline: "0.2kW〜600kW・IP20〜IP66・汎用〜ポンプファン専用",
        desc: "TECO 低電圧インバーターシリーズは、0.2kWから600kWまでの幅広い容量とIP20〜IP66（屋外用）の保護等級に対応します。A510s（汎用VFD）・E510s（コンパクト・EMCフィルタ内蔵）・E710（EtherCAT/CANopen対応高機能形）・F510（ポンプ・ファン専用）・L510s（小型単相入力）の5シリーズで、あらゆる産業ニーズに対応します。",
        lineup: [
          { model: "A510s", spec: "汎用VFD・0.4〜630kW・3Ø 200〜690V・IP20/IP55" },
          { model: "E510s", spec: "コンパクト・0.2〜22kW・EMCフィルタ内蔵・IP20/IP66" },
          { model: "E710", spec: "高機能形・EtherCAT/CANopen内蔵・0.4〜22kW" },
          { model: "F510", spec: "ポンプ・ファン専用・省エネ最適化・0.4〜315kW" },
          { model: "L510s", spec: "小型単相入力・0.2〜2.2kW・IP20/IP65" },
        ],
        apps: ["ポンプ・ファン", "コンベア・ホイスト", "工作機械", "HVACシステム"],
      },
      {
        id: "pmdd",
        name: "PMDD永久磁石ダイレクトドライブ",
        nameEn: "PMDD — Permanent Magnet Direct Drive",
        tagline: "IE5効率・ギアボックス不要・省エネ最大40%",
        desc: "TECO PMDD（Permanent Magnet Direct Drive）は、IE5最高効率クラスの永久磁石ダイレクトドライブシステムです。ギアボックスを完全に排除することで、保守コストと伝達損失を同時になくしました。省エネ率は最大40%、過酷な環境下でも安定した無欠陥のダイレクトドライブにより、産業現場のTCOを刷新します。",
        lineup: [
          { model: "PMDD小型", spec: "IE5・低速高トルク・ギアボックスレス・IP55" },
          { model: "PMDD中型", spec: "IE5・コンベア/プレス専用・省エネ最大40%" },
          { model: "PMDD大型", spec: "IE5・大容量ダイレクトドライブ・産業用ポンプ/攪拌機" },
        ],
        apps: ["コンベアシステム", "産業用ポンプ", "攪拌機", "プレス・圧延機"],
      },
      {
        id: "ac-servo-g3",
        name: "ACサーボ JSDG3-Eシリーズ",
        nameEn: "AC Servo — JSDG3-E Series",
        tagline: "EtherCAT/CANopen・23ビットアブソリュート・最大15kW",
        desc: "TECO JSDG3-Eシリーズは、EtherCAT・CANopen通信と23ビットアブソリュートエンコーダを内蔵した最新世代のACサーボドライバーです。切断精度±0.02mm、最大出力15kWで、半導体装置・産業用ロボット・CNCに最適化されています。高速・高精度・高トルクのトリプルパフォーマンスを実現します。",
        lineup: [
          { model: "JSDG3-E小型", spec: "EtherCAT/CANopen・0.1〜1.5kW・23ビットアブソリュート" },
          { model: "JSDG3-E中型", spec: "EtherCAT/CANopen・2〜7.5kW・±0.02mm切断精度" },
          { model: "JSDG3-E大型", spec: "EtherCAT/CANopen・11〜15kW・半導体/CNC専用" },
        ],
        apps: ["半導体装置", "産業用ロボット", "CNC工作機械", "包装自動化"],
      },
      {
        id: "ac-servo-g2",
        name: "ACサーボ JSDG2Sシリーズ",
        nameEn: "AC Servo — JSDG2S Series",
        tagline: "CANopen・実績ある前世代・0.1〜15kW",
        desc: "TECO JSDG2Sシリーズは、CANopen通信ベースの信頼性の高い前世代ACサーボドライバーです。幅広い現場で実証された信頼性と高い互換性により、既存システムの保守・拡張に最適です。0.1kWから15kWまでの全容量ラインナップに対応します。",
        lineup: [
          { model: "JSDG2S小型", spec: "CANopen・0.1〜1.5kW・17ビットエンコーダ" },
          { model: "JSDG2S中型", spec: "CANopen・2〜7.5kW・現場実績あり" },
          { model: "JSDG2S大型", spec: "CANopen・11〜15kW・レガシーシステム互換" },
        ],
        apps: ["既存システム保守", "自動化ライン拡張", "工作機械", "包装設備"],
      },
      {
        id: "dc-servo",
        name: "DCサーボ（AGV専用）",
        nameEn: "DC Servo — AGV Dedicated",
        tagline: "400W・AGV/AMR最適化・高応答低速トルク",
        desc: "TECO DCサーボは、AGV（無人搬送車）・AMR（自律移動ロボット）専用に設計された400W級の直流サーボドライバーです。低速高トルク特性と高応答制御により、物流自動化・倉庫ロボットに最適化されています。コンパクトなフォームファクターと高い環境耐性が特徴です。",
        lineup: [
          { model: "DCサーボ400W", spec: "400W・AGV/AMR専用・高応答低速トルク" },
          { model: "DCサーボドライバー", spec: "PWM制御・RS232/CAN・コンパクト設計" },
        ],
        apps: ["AGV無人搬送車", "AMR自律移動ロボット", "物流自動化", "倉庫ロボット"],
      },
      {
        id: "stepping-motor",
        name: "ステッピングモーター（2相/5相）",
        nameEn: "Stepping Motor — 2-phase / 5-phase",
        tagline: "2相・5相・精密位置決め・オープンループ制御",
        desc: "TECOステッピングモーターは、2相および5相構成で提供される精密位置決め専用モーターです。エンコーダ不要のオープンループ制御によりシステム構成がシンプルで、低速高トルク特性によりインデックス・XYテーブル・CNC小型軸に最適化されています。NEMA 14〜42の多様なフレームサイズに対応します。",
        lineup: [
          { model: "2相ステッピング（NEMA 14〜23）", spec: "1.8°/ステップ・小型・インデックス/CNC小型軸" },
          { model: "2相ステッピング（NEMA 34〜42）", spec: "1.8°/ステップ・高トルク・大型XYテーブル" },
          { model: "5相ステッピング", spec: "0.72°/ステップ・高精度・最小振動" },
        ],
        apps: ["インデックステーブル", "XYステージ", "CNC小型軸", "ラベリング・ディスペンシング"],
      },
      {
        id: "plc",
        name: "PLC（プログラマブルロジックコントローラ）",
        nameEn: "PLC — Programmable Logic Controller",
        tagline: "200kHz高速カウンティング・Modbus/EtherNet・コンパクト",
        desc: "TECO PLCは、200kHz高速カウンティングとModbus・EtherNet通信を内蔵した産業用プログラマブルロジックコントローラです。コンパクトなフォームファクターでパネル省スペースを実現。サーボ・インバーター・HMIとのTECO統合システム構成により制御効率を最大化します。IEC 61131-3プログラミング規格に対応します。",
        lineup: [
          { model: "TECO PLC基本形", spec: "200kHz高速カウンティング・Modbus RTU/ASCII・コンパクト" },
          { model: "TECO PLC拡張形", spec: "EtherNet/IP・拡張I/O最大512点・アナログ内蔵" },
          { model: "PLC通信モジュール", spec: "EtherCAT・CANopen・DeviceNet選択" },
        ],
        apps: ["自動化ライン制御", "モーションコントロール", "ビル自動化", "TECOサーボ/インバーター統合"],
      },
      {
        id: "hmi",
        name: "HMI（ヒューマンマシンインターフェース）",
        nameEn: "HMI — Human-Machine Interface",
        tagline: "SD 4GB・タッチスクリーン・Modbus/EtherNet",
        desc: "TECO HMIは、4GB SDカードを内蔵し、高精細タッチスクリーンを搭載した産業用ヒューマンマシンインターフェース端末です。Modbus・EtherNet通信によりTECO PLC・インバーター・サーボと統合運用が可能です。直感的なGUI設計ツールにより操作員のトレーニングコストを最小化。IP65のフロントパネル防護を備えます。",
        lineup: [
          { model: "HMI 4.3\"", spec: "4.3インチタッチ・SD 4GB・Modbus・IP65フロント" },
          { model: "HMI 7\"", spec: "7インチタッチ・SD 4GB・EtherNet/Modbus・IP65" },
          { model: "HMI 10\"", spec: "10インチワイドタッチ・SD 4GB・EtherNet/IP・IP65" },
        ],
        apps: ["自動化ラインモニタリング", "TECO PLC/インバーター連携", "工場データ可視化", "遠隔制御パネル"],
      },
    ],
    solutionsTitle: "業界別適用ソリューション",
    solutionsSub: "TECO配電&ドローン技術が適用される主要分野",
    solutionsCta: "このソリューションを問い合わせる",
    solutionsCustomerLabel: "主要適用業界",
    solutions: [
      {
        id: "direct",
        name: "直接モーター駆動",
        challenge: "従来モーターのシンプルなON/OFF制御、コスト効率の良い基本配電構成",
        highlight: "Circuit Breaker → Contactor → Overload Relay → Motor",
        models: ["CU/CN", "RHU", "TCB"],
        metrics: [
          { value: "基本形", label: "構成" },
          { value: "最低", label: "初期コスト" },
          { value: "堅牢", label: "信頼性" },
        ],
        points: [
          "回路遮断器 → コンタクタ → 過負荷継電器 → モーターの標準4段構成による安全な電力供給",
          "シンプルな構造で保守が容易・部品互換性が高く即座に交換可能",
          "TECO単一ブランドで全部品をマッチング — 認証・信頼性・納期を一度に解決",
        ],
        industries: ["ポンプ", "ファン", "コンベア", "工作機械"],
      },
      {
        id: "motor",
        name: "モーター保護ブレーカー",
        challenge: "始動電流・過負荷・欠相保護を一体化したコンパクト構成",
        highlight: "Motor Protection CB + Contactor + Motor",
        models: ["TMS-S", "TMC-E", "CU"],
        metrics: [
          { value: "統合", label: "保護機能" },
          { value: "コンパクト", label: "パネル空間" },
          { value: "0.1~32A", label: "範囲" },
        ],
        points: [
          "TMS-Sシリーズ1台で回路遮断＋過負荷＋欠相保護を一体化 — パネル空間を30%削減",
          "別途の過負荷継電器が不要・配線の簡素化により設置時間を短縮",
          "0.1〜32Aの広範な定格で小型〜中型モーターすべてに対応",
        ],
        industries: ["小型モーター", "コンプレッサー", "BLDCシステム", "ポンプパッケージ"],
      },
      {
        id: "vfd",
        name: "VFD（インバーター）スターター",
        challenge: "可変速制御、省エネ、精密トルク制御が必要な環境",
        highlight: "Circuit Breaker → Contactor → VFD → Motor",
        models: ["TCB", "CU", "TECO VFD"],
        metrics: [
          { value: "可変速", label: "精密制御" },
          { value: "30%↓", label: "省エネ" },
          { value: "統合", label: "保護内蔵" },
        ],
        points: [
          "VFDが始動・停止・過負荷保護までを統合 — モーター寿命を2倍以上延長",
          "回生制動と可変速制御により、エネルギー使用量を平均30%削減",
          "TECOコンタクタ・遮断器・VFDのフルラインナップマッチングでシステム統合を検証済み",
        ],
        industries: ["HVAC", "圧縮機", "ファン・ブロワー", "物流コンベア"],
      },
      {
        id: "servo",
        name: "サーボスターター",
        challenge: "精密位置制御・高応答性が求められる自動化・ロボット環境",
        highlight: "Circuit Breaker → Contactor (Optional) → Servo Driver → Motor",
        models: ["TCB", "TMC-E", "Servo"],
        metrics: [
          { value: "マイクロ", label: "精密制御" },
          { value: "高速", label: "応答性" },
          { value: "統合", label: "安全保護" },
        ],
        points: [
          "サーボドライバーが始動・停止・過負荷保護を内包 — コンタクタはオプションとしてのみ追加",
          "マイクロ単位の位置制御により、ロボット・半導体装置・精密自動化に最適",
          "TECO遮断器とマッチングするサーボシステム統合ソリューション",
        ],
        industries: ["産業用ロボット", "半導体装置", "工作機械", "包装自動化"],
      },
      {
        id: "drone-survey",
        name: "測量・マッピングドローン",
        challenge: "長時間飛行、精密GPSデータ収集、広範囲エリアのカバー",
        highlight: "軽量ドローンモーター＋ESC・高効率で飛行時間を延長",
        models: ["3508 KV650", "5308 KV280", "LC-ESC-20A-6S"],
        metrics: [
          { value: "11W/g", label: "推力効率" },
          { value: "91.8%", label: "最高効率" },
          { value: "200°C", label: "耐熱性" },
        ],
        points: [
          "Halbach Array設計により同クラス最高効率を達成 — 同一バッテリーで飛行時間+30%",
          "日本製ベアリング・高級絶縁鋼板により200°C環境でも安定動作",
          "測量・LiDAR・マルチスペクトルカメラのペイロードを安定運用",
        ],
        industries: ["国土測量", "建設現場マッピング", "農地分析", "鉱物探査"],
      },
      {
        id: "drone-agri",
        name: "農薬散布・輸送",
        challenge: "150kgの農薬・物資輸送、過酷な農業環境への耐久性",
        highlight: "中型UAVパワートレイン・150kgペイロード・特許5件",
        models: ["UAV Drone 1", "UAV ESC 300A", "BLDC Motor 76.5kg"],
        metrics: [
          { value: "150kg", label: "最大ペイロード" },
          { value: "20g", label: "耐衝撃性" },
          { value: "5件", label: "特許技術" },
        ],
        points: [
          "月産1,400台以上の量産実績を持つ農業ドローンモーター — 350機以上のUAVに搭載され稼働中",
          "コンフォーマルコーティング・高耐塩水噴霧性により、農薬・潮風環境に完璧に対応",
          "スロット内空冷＋ベアリングスリップ防止設計により、高温・高負荷での長時間運用が可能",
        ],
        industries: ["農薬散布", "種子散布", "緊急物流", "災害救助"],
      },
      {
        id: "drone-inspect",
        name: "産業点検・セキュリティ",
        challenge: "精密ホバリング、カメラ・センサーの安定運用、夜間・悪天候飛行",
        highlight: "軽量モーター＋ESC・精密な飛行安定性",
        models: ["6013 KV210", "10010 KV110", "LC-ESC-40A-12S"],
        metrics: [
          { value: "±0.1m", label: "ホバリング精度" },
          { value: "98%", label: "ESC効率" },
          { value: "拡張形", label: "ペイロード" },
        ],
        points: [
          "高出力モーター＋95〜98%効率のESCの組み合わせで、重い点検機材を安定運用",
          "発電所・送電塔・橋梁・風力ブレードの精密点検に最適",
          "夜間セキュリティ・国境監視・災害モニタリング向けの長時間飛行が可能",
        ],
        industries: ["電力インフラ点検", "橋梁・トンネル", "セキュリティ監視", "災害モニタリング"],
      },
      {
        id: "fcu-app",
        name: "ファンコイルユニット（FCU）",
        challenge: "住宅・商業・公共建築のHVACエネルギー効率向上、従来PSCモーターの代替",
        highlight: "EC Motor(D98) + Driver Board → FCU System",
        models: ["D98 EC-PMSM", "FCU-#300", "FCU-#600"],
        metrics: [
          { value: "70%↓", label: "消費電力削減" },
          { value: ">80%", label: "モーター効率" },
          { value: "PF>95%", label: "力率" },
        ],
        points: [
          "従来のPSC（誘導）モーターと比較して消費電力を最大70%削減 — SINKO GSRCの実証事例",
          "無段階アナログ速度制御により体感快適性を向上し、騒音を最小化",
          "Modbus/RS485通信によりBMS・BEMSと統合したモニタリング・遠隔制御が可能",
        ],
        industries: ["住宅建物", "ホテル・ホスピタリティ", "オフィスビル", "公共インフラ"],
      },
      {
        id: "ffu-app",
        name: "ファンフィルターユニット（FFU）・クリーンルーム",
        challenge: "半導体・バイオ医薬・医療施設における厳格な清浄度維持と省エネ",
        highlight: "External Rotor ECM(OD102) + Centrifugal Fan → FFU System",
        models: ["OD102 External Rotor", "FFU-4×2", "FFU-4×4"],
        metrics: [
          { value: "IP55", label: "保護等級" },
          { value: "ISO1~8", label: "クリーンルーム等級" },
          { value: "<10%", label: "THD-A（高調波）" },
        ],
        points: [
          "アウターロータ形ECモーター＋遠心ファン直結駆動で、クリーンルームの騒音・振動を最小化",
          "2×4および4×4 FFU標準タイルサイズに完全に適合 — 半導体・バイオ医薬に即座に適用可能",
          "THD-A＜10%の低高調波により、精密機器へのEMI干渉を最小化",
        ],
        industries: ["半導体ファブ", "バイオ医薬・医療", "LCD/OLED製造", "航空宇宙MRO"],
      },
      {
        id: "ahu-app",
        name: "空気調和ユニット（AHU）",
        challenge: "大型商業建築・病院・データセンターの大容量空調エネルギー最適化",
        highlight: "Internal Rotor ECM(D98/D125) + Blower → AHU System",
        models: ["D98 / D125 EC-PMSM", "AHU-#800", "AHU-#1600"],
        metrics: [
          { value: "800~1600", label: "CFM範囲" },
          { value: ">85%", label: "モーター効率（D125）" },
          { value: "RS485", label: "通信プロトコル" },
        ],
        points: [
          "PWM電力制御＋RS485通信により、BAS/BEMS統合とデマンドレスポンス（DR）に対応",
          "D125デュアル軸モーターによるAHU-#1600の大容量空調 — 病院・ホテル・データセンターに最適",
          "Modbusによる電力・運転状態のリアルタイム監視で予知保全（PM）を実現",
        ],
        industries: ["商業ビル", "病院・ヘルスケア", "データセンター", "公共インフラ"],
      },
    ],
    casesTitle: "導入事例",
    casesSub: "TECO ECMが採用されたグローバル導入実績",
    ecmMarketTitle: "ECMグローバル市場動向",
    ecmMarketSub: "2026年 USD 27.6B → 2032年 USD 41.9B（CAGR 7.2%）",
    ecmDownloadLabel: "ECMカタログPDFダウンロード",
    aboutTitle: "TECO Electric & Machinery紹介",
    aboutDesc:
      "TECOは1956年に台湾で設立されたグローバル電気・機械総合メーカーです（TWSE 1504）。70年の伝統を基盤に、産業用モーター市場で台湾No.1、グローバルTop 5の地位を確立しており、2024年のM&Aを通じて変圧器事業へ拡大しています。Westinghouse、Motovario、TEMICOなど100社のグローバル関連会社とともに、33の事業拠点、10の製造工場、3つのイノベーションセンターを運営しています。グリーンエネルギー・電動化・インテリジェント化のトータルソリューションパートナーとして、世界25,000名以上の従業員がUSD 2.2B+の売上を創出しています。",
    aboutMission: "Mission",
    missionText: "グローバルな電動化・インテリジェント化・グリーンエネルギー実現の中核的な原動力として、モーター・配電・ドライブ・ドローンモーターなど全ラインナップで持続可能な未来を共に築いていきます。",
    aboutVision: "Vision",
    visionText: "Move to Lead — 70年の伝統を礎に、次世代の電動化時代をリードするグローバルトータルソリューション企業。",
    customerTitle: "主要関連会社＆グローバルパートナー",
    certTitle: "認証＆規格",
    certs: [
      { name: "ISO 9001", desc: "品質マネジメントシステム" },
      { name: "CSA", desc: "カナダ安全認証" },
      { name: "UL", desc: "米国安全認証" },
      { name: "CE", desc: "欧州適合性認証" },
      { name: "CCC", desc: "中国強制認証" },
      { name: "RoHS", desc: "有害物質制限指令" },
      { name: "IEC 60947", desc: "低圧開閉装置規格" },
      { name: "GB 14048", desc: "中国低圧規格" },
    ],
    whyTitle: "OHI Tech × TECOパートナーシップ",
    whys: [
      { title: "70年のグローバル実績", desc: "1956年創立・40カ国進出・LV配電で台湾No.2・産業用モーターでグローバルTop 5という実証済みの信頼性。" },
      { title: "トータルラインナップ供給", desc: "遮断器・コンタクタ・継電器・ドローンモーター・ESCまで単一ブランドで統合供給 — 互換性・納期・認証を一度に解決。" },
      { title: "韓国総代理店による直接供給", desc: "OHI Techが韓国総代理店として在庫・技術サポート・納期を直接管理。迅速な見積りと安定供給を実現します。" },
      { title: "カスタム統合コンサルティング", desc: "単なる部品供給にとどまらず、システム設計・マッチング・テスト・納品までapplication-focusedなソリューションを提供します。" },
    ],
    ctaTitle: "TECO製品の導入をご検討中ですか？",
    ctaDesc: "配電部品・ドローンモーター・ESCの仕様相談から見積りまで、OHI Techの専門チームが迅速に対応します。",
    ctaBtn1: "今すぐ問い合わせる",
    ctaBtn2: "導入事例を見る",
  },
};
...
const ECM_CASES = [
  {
    ...
    saving: "70%",
    savingLabel: { ko: "에너지 절감", en: "Energy Saved", zh: "节能率", ja: "省エネ率" },
    desc: {
      ...
      ja: "日本の空調専門メーカーSINKO Industriesが、TECO ECMを搭載した省エネ型FCUを発売しました。従来の交流モーターと比較し（Lo運転時）、消費電力を最大70%削減しています。BLAC PMSMモーターにより高効率を実現し、コントローラー一体化で交換の利便性を最大化しています。",
    },
    tags: { ko: ["팬 코일 유닛", "에너지 절약", "BLAC PMSM", "일본 레퍼런스"], en: ["Fan Coil Unit", "Energy Saving", "BLAC PMSM", "Japan Reference"], zh: ["风机盘管", "节能", "BLAC PMSM", "日本案例"], ja: ["ファンコイルユニット", "省エネ", "BLAC PMSM", "日本の事例"] },
  },
];
...
const PRODUCT_GROUPS: { id: string; label: Record<string, string>; ids: string[] }[] = [
  {
    id: "power-dist",
    label: { ko: "배전 기기", en: "Power Distribution Devices", zh: "配电设备", ja: "配電機器" },
    ids: ["contactor", "overload", "breaker"],
  },
  {
    id: "drone",
    label: { ko: "드론 파워트레인", en: "Drone Powertrain", zh: "无人机动力总成", ja: "ドローンパワートレイン" },
    ids: ["drone", "uav", "esc"],
  },
  {
    id: "ecm",
    label: { ko: "ECM · HVAC 솔루션", en: "ECM · HVAC Solutions", zh: "ECM · 暖通空调解决方案", ja: "ECM・HVACソリューション" },
    ids: ["ecm-ir", "ecm-er", "ecm-drv", "ecm-int", "fcu", "ffu", "ahu"],
  },
  {
    id: "drives",
    label: { ko: "인버터 · 서보 · PLC", en: "Inverter · Servo · PLC", zh: "变频器 · 伺服 · PLC", ja: "インバーター・サーボ・PLC" },
            ...
            <div>
              ...
              <div className="mt-6 mb-6">
                ...
                <div className="space-y-0 border-l-2 border-slate-200 pl-4">
                  {[
                    { year: "1956", ko: "대만 타이중 창립 — 산업용 모터 전문", en: "Founded in Taichung, Taiwan — industrial motors", zh: "台中创立 — 工业电机专业", ja: "台湾台中で創立 — 産業用モーター専門" },
                    { year: "1972", ko: "TWSE 상장 (코드 1504)", en: "Listed on TWSE (ticker 1504)", zh: "TWSE 上市（代码 1504）", ja: "TWSE上場（コード1504）" },
                    { year: "1988", ko: "미국 TECO-Westinghouse 설립", en: "Established TECO-Westinghouse USA", zh: "成立美国 TECO-Westinghouse", ja: "米国TECO-Westinghouseを設立" },
                    { year: "1995", ko: "이탈리아 Motovario 인수", en: "Acquired Motovario, Italy", zh: "收购意大利 Motovario", ja: "イタリアMotovarioを買収" },
                    { year: "2001", ko: "인도 TEMICO 설립", en: "Established TEMICO, India", zh: "成立印度 TEMICO", ja: "インドTEMICOを設立" },
                    { year: "2010", ko: "신재생에너지 사업 진입", en: "Entered renewable energy sector", zh: "进入可再生能源领域", ja: "再生可能エネルギー事業に参入" },
                    { year: "2019", ko: "드론 모터 사업 시작", en: "Launched drone motor business", zh: "启动无人机电机业务", ja: "ドローンモーター事業を開始" },
                    { year: "2025", ko: "변압기 사업 확장", en: "Expanded into transformer business", zh: "扩展变压器业务", ja: "変圧器事業を拡大" },
                  ].map((m) => (
