    ...
    <div className="-mx-4 sm:-mx-6 lg:-mx-8">
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-6 pb-6 border-b border-slate-100">
                    {currentSolution.metrics.map((m, i) => (
                      <div key={i} className="text-center bg-slate-50 rounded-xl py-3 px-2">
                        <div className="text-lg font-black text-violet-500">{m.value}</div>
      ...
      <section className="bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <p className="text-violet-500 text-xs font-bold uppercase tracking-widest mb-3">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-violet-500 pl-4">
                  <p className="text-xs font-bold text-violet-500 mb-1">{c.aboutMission}</p>
      ...
      <section className="bg-gradient-to-r from-violet-600 to-purple-700">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-14 text-center">
          ...
          <p className="text-violet-100 text-sm mb-8 max-w-lg mx-auto">{c.ctaDesc}</p>
          <div className="flex flex-wrap gap-3 justify-center">
            <Link
              href={`/contact?lang=${locale}&type=inquiry&category=wafer-carrier`}
              className="bg-white text-violet-600 hover:bg-violet-50 px-8 py-3.5 rounded-xl font-bold text-sm transition-colors shadow-lg"
            >
              {c.ctaBtn1}
            </Link>
            <Link
              href={`/contact?lang=${locale}&type=sample&category=wafer-carrier`}
              className="bg-violet-800 hover:bg-violet-900 text-white border border-violet-400/30 px-8 py-3.5 rounded-xl font-bold text-sm transition-colors"
            >
              {c.ctaBtn2}
            </Link>
          </div>
